...
type HashBackendFactory interface {
	New(diskdb ethdb.Database, resolver ChildResolver) HashBackend
}
...
type PathBackendFactory interface {
	New(diskdb ethdb.Database) PathBackend
}
